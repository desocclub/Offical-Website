...
const SectionTitle = ({ children, sub }: { children: React.ReactNode; sub?: string }) => (
  <div className="flex items-center mb-8 sm:mb-10">
    ...
    <div>
      ...
      {sub && <p className="text-red-400 text-xs sm:text-sm mt-1 uppercase tracking-wider" style={{ fontWeight: 'var(--font-weight-medium)' }}>{sub}</p>}
    </div>
  </div>
);
                ...
                <GlassCard delay={200} isLoaded={isLoaded}>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button
                      ...
                      className="w-full sm:w-auto px-8 py-3.5 bg-linear-to-r from-red-700 to-red-600 text-white font-bold uppercase tracking-wider rounded-full hover:from-red-600 hover:to-red-500 transition-all duration-300 hover:scale-105 cursor-pointer disabled:opacity-50"
