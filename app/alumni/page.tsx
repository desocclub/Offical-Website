...
export const metadata = {
  title: 'Alumni — DESOC',
  description: 'Celebrating the people who shaped DESOC and continue to carry its spirit beyond campus.',
};
...
const GlassCard = ({ children, delay = 0, isLoaded }: GlassCardProps) => (
  <section
...
const SectionTitle = ({ children, sub }: SectionTitleProps) => (
...
const CommitteeAlumniCard = ({ member }: { member: AlumniMember }) => (
  <article className="group relative overflow-hidden rounded-xl border border-white/10 bg-black/30 transition-all duration-300 hover:-translate-y-1 hover:border-[#bc0034]/60 hover:shadow-[0_12px_30px_rgba(188,0,52,0.18)]">
    <div className="aspect-[3/4] overflow-hidden bg-[#19050b] flex items-center justify-center">
      {member.image ? (
        <img
