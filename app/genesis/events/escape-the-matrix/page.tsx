...
import escapeImg from '@/src/assets/genesis/escape.jpeg';

export const metadata = {
  title: 'Escape The Matrix — Genesis 2026 | DESOC',
  description: 'A simulation-style mission where participants play as trapped programs and complete linked challenges to escape the Matrix.',
};
...
export default function EscapeTheMatrixEventPage() {
  return (
