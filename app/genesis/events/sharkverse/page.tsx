...
import sharkverseImg from '@/src/assets/genesis/sharkverse.jpeg';

export const metadata = {
  title: 'Sharkverse — Genesis 2026 | DESOC',
  description: 'Simulated startup pitch arena where innovation meets strategy and investor-style decision making.',
};

const sharkversePptTemplate = '/downloads/Shark_Verse_20260318_202659_0000.pptx';
...
export default function SharkverseEventPage() {
  return (
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <section className="pt-2">
              <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
                <Link
                  href="/genesis/register?event=Sharkverse"
