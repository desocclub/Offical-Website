...
import sharkverseFlyer from '@/src/assets/genesis/sharkverse.jpeg';
import bidAndBuildFlyer from '@/src/assets/genesis/bidnbuild.jpeg';
import escapeFlyer from '@/src/assets/genesis/escape.jpeg';
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 mt-10 sm:mt-12 mb-8 sm:mb-10">
                {majorEvents.map((event) => (
                  ...
                  >
                    ...
                    <p className="mx-auto max-w-175 text-center text-tertiary text-sm sm:text-base leading-relaxed mb-6">
                      {event.description}
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                      {event.registrationsClosed ? (
                        ...
                        <Link
                          href={`/genesis/register?event=${encodeURIComponent(event.registerEvent)}`}
                ...
                {faqs.map((faq, i) => (
                  ...
                  >
                    <button
                      ...
                      className="w-full flex items-center justify-between px-5 sm:px-6 py-4 text-left transition-all duration-200 cursor-pointer"
                    >
