...
export const metadata = {
  title: 'Committee — DESOC',
  description: 'Meet the team that will shape the next year of DESOC.',
};
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-black text-white">
      ...
      <main className="relative isolate flex min-h-screen items-center justify-center px-4 pb-16 pt-24 sm:px-6 lg:px-8">
        ...
        <section className={`relative w-full max-w-5xl text-center transition-all duration-1000 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
          ...
          <div className="mx-auto mt-7 flex max-w-xl items-center justify-center gap-3">
            ...
            <span className="text-sm font-light uppercase tracking-[0.28em] text-[#f26183] sm:text-base">Revealing soon</span>
        ...
        <p className="pointer-events-none absolute bottom-7 left-1/2 -translate-x-1/2 whitespace-nowrap text-[10px] uppercase tracking-[0.3em] text-gray-600 sm:text-xs">Watch this space</p>
      </main>
