import type { Event, FormattedEventSchedule } from '@/types/events';
 ...
 */
export function formatEventDate(event: Event): FormattedEventSchedule {
  ...
  const dateOptions: Intl.DateTimeFormatOptions = { timeZone, day: 'numeric', month: 'short' };
  ...
  const timeOptions: Intl.DateTimeFormatOptions = { timeZone, hour: 'numeric', minute: '2-digit', hour12: true };
